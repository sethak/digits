    ...
    return (
        ...
        <Grid container stackable centered columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h1' inverted>This address book enables any number of users to login and save
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h1' inverted>For each contact you can save their name, address, and phone number.</Header>
          </Grid.Column>
